  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        <img src={bill} alt="billing" className="relative z-[5] h-full w-full" />
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className="mt-6 flex flex-row flex-wrap sm:mt-10">
          <img src={apple} alt="apple_store" className="mr-5 h-[42px] w-[128px] cursor-pointer object-contain" />
          <img src={google} alt="google_play" className="h-[42px] w-[128px] cursor-pointer object-contain" />
        </div>
      </div>
    </section>
  );
